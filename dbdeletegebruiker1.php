...
<body>
    ...
    <!--Main-->
    <div class="container">
        <form style="margin-top: 50px" action="dbdeletegebruiker2.php" method="post">
        <div class="form-group mx-sm-12 mb-10">
            <label for="inputPassword2" class="sr-only">Userid</label>
            <input name="useridvak" type="text"  class="form-control" id="inputPassword2" placeholder="Plaats userid hier" value="">
            <input value="Verwijderen" style="margin-top: 20px" type="submit" class="btn btn-danger mb-2">
        </div>
        </form>
        </div>
