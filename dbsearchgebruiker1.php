...
<body>
    ...
    <!-- Einde navigatie menu -->
      ...
      <!--zoeken via Userid-->
      <div class="container">
    <form style="margin-top: 50px" action="dbsearchgebruiker2.php" method="post" class="form-inline">
       <div class="form-group mx-sm-12 mb-10">
         <label for="inputPassword2" class="sr-only">Userid</label>
         <input type="text" name="useridvak" class="form-control" id="inputPassword2" placeholder="Plaats een userid hier">
