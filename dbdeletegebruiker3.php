...
<body>
    ...
    <?php
            ...
            // gebruiker gegevens verwijderen
            if($userid)
            {
                ...
                echo"<div style='text-align: center;' class='alert alert-success' role='alert'><p style='margin-bottom: 5px;'>gebruiker is succevol verwijderd</p></div>";
            }
            else
            {
                echo"<div style='text-align: center;' class='alert alert-danger' role='alert'><p style='margin-bottom: 5px;'>gebruiker kon niet verwijderd worden</p></div>";
            }
